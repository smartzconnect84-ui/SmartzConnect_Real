-- ╔══════════════════════════════════════════════════════════════════════════╗
-- ║  SmartzConnect — MASTER SUPABASE SCHEMA                                  ║
-- ║  Single file to run in: Supabase Dashboard → SQL Editor → Run           ║
-- ║  FULLY IDEMPOTENT — safe to run multiple times (CREATE IF NOT EXISTS,   ║
-- ║  ON CONFLICT DO NOTHING, DO $$ EXCEPTION blocks throughout).            ║
-- ╠══════════════════════════════════════════════════════════════════════════╣
-- ║  Covers:                                                                  ║
-- ║   1. Extensions & Helper Functions                                        ║
-- ║   2. Core User Tables (profiles, users, admin_users)                     ║
-- ║   3. Social & Messaging (posts, messages, notifications, matches)        ║
-- ║   4. Marketplace (items, wishlist, orders)                               ║
-- ║   5. SmartzTV / Streaming (streams, gifts, tokens)                       ║
-- ║   6. SmartzRide (drivers, ride_requests)                                 ║
-- ║   7. Payments & Subscriptions (plans, user_subscriptions, payments)      ║
-- ║   8. Content & Admin (blog, team, ads, broadcasts, audit, safety)        ║
-- ║   9. Push Notifications                                                   ║
-- ║  10. Storage Buckets & Policies                                           ║
-- ║  11. Realtime Publication                                                 ║
-- ║  12. Payment Trigger Functions                                            ║
-- ╚══════════════════════════════════════════════════════════════════════════╝
...
-- ╔══════════════════════════════════════════════════════════════════════════╗
-- ║  SECTION 11 — PAYMENT TRIGGER FUNCTIONS                                  ║
-- ╚══════════════════════════════════════════════════════════════════════════╝

-- Auto-expire pending payments after their timeout window
...
-- Auto-activate subscription when admin verifies a payment
...
-- ╔══════════════════════════════════════════════════════════════════════════╗
-- ║  SECTION 12 — VERIFICATION (run after applying, read the output)         ║
-- ╚══════════════════════════════════════════════════════════════════════════╝
